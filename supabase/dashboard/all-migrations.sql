...
-- ===== 20260926100000_in_person_sms_otp.sql =====
...
-- ===== 20260926110000_sms_credits.sql =====
...
insert into supabase_migrations.schema_migrations (version, name, statements) values ('20260926100000', 'in_person_sms_otp', '{}') on conflict (version) do nothing;
insert into supabase_migrations.schema_migrations (version, name, statements) values ('20260926110000', 'sms_credits', '{}') on conflict (version) do nothing;
commit;
